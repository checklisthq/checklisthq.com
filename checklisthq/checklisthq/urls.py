...
urlpatterns = patterns('',
    ...
    url(r'^checklist/(?P<id>[0-9]+)/comments$', 'main.views.checklist_comments', name='checklist_comments'),
    url(r'^checklist/(?P<id>[0-9]+)/edit$', 'main.views.edit_checklist', name='edit_checklist'),
    url(r'^checklist/(?P<id>[0-9]+)/clone$', 'main.views.clone_checklist', name='clone_checklist'),
    url(r'^checklist/(?P<id>[0-9]+)/print$', 'main.views.print_checklist', name='print_checklist'),
