...
urlpatterns = patterns('',
    ...
    url(r'^user/(?P<username>[a-zA-Z0-9_\.@\+\-]+)$',
        'main.views.checklist_list', name="checklist_list"),
    ...
    url(r'^checklist/(?P<id>[0-9]+)$', 'main.views.view_checklist',
        name='view_checklist'),
    url(r'^checklist/(?P<id>[0-9]+)/comments$',
        'main.views.checklist_comments', name='checklist_comments'),
    url(r'^checklist/(?P<id>[0-9]+)/edit$', 'main.views.edit_checklist',
        name='edit_checklist'),
